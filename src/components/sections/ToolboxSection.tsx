...
function TechIcon({ icon }: { icon: string }) {
  ...
  const simpleIcon = iconMap[icon as keyof typeof iconMap];
...
export default function ToolboxSection({ toolboxItems = [], toolboxCategories = [] }: { toolboxItems?: any[], toolboxCategories?: string[] }) {
