...
type TerminalLine = { text: string; isCommand: boolean };

function useTypingAnimation(lines: TerminalLine[], speed: number = 40) {
...
function useCountUp(target: number, duration: number = 2000, startOnView: boolean = false) {
